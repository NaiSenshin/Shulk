...
class EnsureMetadataTask : public Task {
   ...
   private slots:
    ...
    void updateMetadataCallback(const QString& slug, Resource* resource);
    void finishMetadataUpdates();
   ...
   private:
    ...
    int m_pendingMetadataUpdates = 0;
    bool m_projectLookupFinished = false;
};
